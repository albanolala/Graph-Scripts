...
##         Testare lo script prima della messa in produzione.
        .SYNOPSIS
        Cancellazione email prima di una determinata data
        .DESCRIPTION
        ...
        .PARAMETER date
        Data discriminante per la cancellazione delle email, verranno cancellate tutte le email precedenti a quella data (è un "<data" NON "<=data")
        ...
        .EXAMPLE
        .\graph-DeleteOldMails.ps1 -Mailbox "utente@contoso.com" -ClientSecret $clientSecret -ClientID $clientID -TenantID $tenantID -date "2021-12-26T00:00:00Z"
